                    ...
                    case 3: {
                        ...
                        for (int i = 0; i < cadAluno; i++) {
                            if (strcmp(alunos[i].nome, nome) == 0) {
                                ...
                                printf("Escreva o novo número do aluno: ");
            ...
            do {
                ...
                switch (opcaoProf) {
                    case 1: {
                        ...
                        printf("Escreva o número do professor: ");
                        scanf("%f", &professores[cadProf].numero);
                        getchar();
            
                        printf("Escreva a matéria do professor: ");
                    ...
                    case 3: {
                        ...
                        for (int i = 0; i < cadProf; i++) {
                            if (strcmp(professores[i].nome, nome) == 0) {
                                ...
                                printf("Escreva o novo número do professor: ");
                                scanf("%f", &professores[i].numero);
            
                                printf("Escreva a nova matéria do professor: ");
